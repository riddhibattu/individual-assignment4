...
![Horse populations for all provinces in Canada from 1906 - 1972.](horse_pops_plot.png){#fig-horse-pops-plot width=80%}
...
![Horse populations for the province with the largest standard deviation](horse_pops_plot_largest_sd.png){#fig-horse-pops-plot-sd width=70%}

In @fig-horse-pops-plot-sd we zoom in and look at the province of `{python} largest_sd`, which had the largest spread of values in terms of standard deviation.
